...
import org.vizadev.ddcapp.domain.Employee;
import org.vizadev.ddcapp.repository.EmployeeRepository;
...
public class EmployeeResourceIT {
    ...
    private static final String DEFAULT_UMANE = "AAAAAAAAAA";
    private static final String UPDATED_UMANE = "BBBBBBBBBB";
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getUmane()).isEqualTo(DEFAULT_UMANE);
    ...
    @Test
    @Transactional
    public void checkUmaneIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setUmane(null);
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].umane").value(hasItem(DEFAULT_UMANE)))
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.umane").value(DEFAULT_UMANE))
    ...
    public void updateEmployee() throws Exception {
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getUmane()).isEqualTo(UPDATED_UMANE);
