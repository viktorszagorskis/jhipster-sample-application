...
import { BriefingComponent } from 'app/entities/briefing/briefing.component';
...
describe('Component Tests', () => {
  describe('Briefing Management Component', () => {
    let comp: BriefingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BriefingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.briefings && comp.briefings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
